...
${OBJECTDIR}/src/TcpConnection.o: src/TcpConnection.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iincl -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TcpConnection.o src/TcpConnection.cpp
...
${OBJECTDIR}/src/UdpConnection.o: src/UdpConnection.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iincl -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/UdpConnection.o src/UdpConnection.cpp
